export default function Jsconf() {
    return (
        <svg
            role="img"
            width="1000"
            height="1000"
            className="md:size-3.5 size-3.5"
            data-astro-cid-5ql2mvdm="true"
        >
            <symbol viewBox="0 0 750 750" id="a:1">
                <defs>
                    <clipPath id="a">
                        <path d="M0 0h750v182.406H0Zm0 0"></path>
                    </clipPath>
                </defs>
                <path fill="#fff" d="M-75-75h900v900H-75z"></path>
                <path fill="#fff" d="M-75-75h900v900H-75z"></path>
